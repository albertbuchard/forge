  ...
  return (
    <div className="grid gap-5">
      <PageHero
        ...
        title={title}
        description="Permissioned Work application context with immutable revision history."
      ...
      <div className="grid gap-5 px-4 sm:px-6">
        ...
        {kind === "interviews" ? (
          <div className="grid gap-5 lg:grid-cols-2">
            ...
            <Card>
              ...
              <div className="mt-3">
                <EvidenceList title="Focus areas" items={item.focusAreas} />
              </div>
              {item.preparationArtifactId ? (
                ...
                >
                  Open preparation Artifact
                </Link>
              ) : (
                <p className="mt-4 text-sm text-[var(--ui-ink-faint)]">
                  No preparation Artifact linked.
                </p>
              )}
              <div className="mt-4">
                <EvidenceList
            ...
            <Card>
              ...
              <FactsGrid
                facts={[
                  ...
                  { label: "Engagement type", value: terms.employmentType },
                  { label: "Start date", value: formatDate(terms.startDate) },
                  { label: "Location", value: record(terms.location).label }
                ]}
              />
            </Card>
            <Card>
              ...
              <p className="mt-3 text-xs leading-5 text-[var(--ui-ink-faint)]">
                This section requires the separate Work compensation permission.
              </p>
            </Card>
          </div>
        ) : null}
        ...
        <Card>
          ...
          <p className="mt-2 text-sm leading-6 text-[var(--ui-ink-medium)]">
            {String(
              item.nextAction ?? item.decision ?? "No next action recorded."
            )}
          </p>
        </Card>
        {kind === "offers" &&
        ["received", "negotiating", "revised"].includes(String(item.status)) &&
        !item.plannedEngagementId ? (
          <Card>
            ...
            <p className="mt-2 text-sm leading-6 text-[var(--ui-ink-soft)]">
              Acceptance creates one planned Work Engagement from this exact
              offer revision, moves the application to accepted, and preserves
              both histories.
            </p>
            {confirmAccept ? (
              <div className="mt-4 rounded-[18px] border border-[color-mix(in_srgb,var(--warning)_35%,var(--ui-border-subtle))] p-4">
                ...
                <p className="mt-1 text-xs leading-5 text-[var(--ui-ink-soft)]">
                  Forge will not infer acceptance from receipt or negotiation
                  alone.
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  <Button
              ...
              <Button className="mt-4" onClick={() => setConfirmAccept(true)}>
