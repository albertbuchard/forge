...
describe("question flow simulation cycles", () => {
  ...
  const specializedSurfaceRouteScenarios = {
    ...
    Workbench: {
      ...
      flowVersions: "Review bounded saved-contract history for one flow.",
      flowVersion: "Read one exact saved flow contract revision.",
      restoreFlow:
        "Restore one retained contract as a new revision after checking the current revision.",
      ...
      cancelRun: "Stop one exact active run and retain its terminal receipt.",
