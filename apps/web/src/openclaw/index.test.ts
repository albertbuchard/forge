...
import packageManifest from "../../../../plugins/openclaw/openclaw.plugin.json";
import publicPackageJson from "../../../../plugins/openclaw/package.json";
import pluginEntry, {
