import type {
  ...
  WorkbenchPortKind,
  WorkbenchPortShapeField,
  WorkbenchToolDefinition
} from "./nodes.js";
import {
  getWorkbenchEntityPortShape,
  getWorkbenchModelPortShape,
...
type InputDefinitionInput = OutputDefinitionInput;

type ParamDefinitionInput = {
  key: string;
  label: string;
  kind: WorkbenchParamDefinition["kind"];
  description?: string;
  required?: boolean;
  options?: WorkbenchParamDefinition["options"];
};

export function createOutputDefinition(
  input: OutputDefinitionInput
): WorkbenchOutputDefinition {
...
export function createInputDefinition(
...
export function createParamDefinition(
...
export function createSearchOutputs(input: {
  ...
  ] satisfies WorkbenchOutputDefinition[];
}
...
export function createSearchParams(input: {
  ...
  return [
    ...
    createParamDefinition({
      ...
      kind: "array",
      description:
        "Used when no entity types input edge is connected. Enter a JSON array or comma-separated values."
    }),
    createParamDefinition({
      key: "limit",
      label: "Default limit",
  ...
  ] satisfies WorkbenchParamDefinition[];
}
...
export function createSearchEntitiesTool(description: string): WorkbenchToolDefinition {
  return {
...
export function createNoteTool(description: string): WorkbenchToolDefinition {
  return {
...
export function createTaskStatusTool(description: string): WorkbenchToolDefinition {
  return {
