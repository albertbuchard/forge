...
- `apps/ios-companion/fastlane/screenshots/en-US/iphone-65/01-pairing.png`
- `apps/ios-companion/fastlane/screenshots/en-US/iphone-65/02-home.png`
- `apps/ios-companion/fastlane/screenshots/en-US/iphone-65/03-life-timeline.png`
- `apps/ios-companion/fastlane/screenshots/en-US/iphone-65/04-diagnostics.png`
...
- `en-US` is the source locale. The Fastlane release pipeline automatically mirrors this
  screenshot set into every locale listed in `apps/ios-companion/release/release.yml` under
