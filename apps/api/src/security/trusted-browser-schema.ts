export const SECURITY_TRUSTED_BROWSER_SCHEMA_SQL = `
CREATE TABLE IF NOT EXISTS security_trusted_browser_credentials (
  id TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_security_trusted_browser_owner
  ON security_trusted_browser_credentials (owner_id, revoked_at, created_at);

CREATE INDEX IF NOT EXISTS idx_security_trusted_browser_client
...
CREATE INDEX IF NOT EXISTS idx_security_trusted_browser_challenge_expiry
...
CREATE TRIGGER IF NOT EXISTS trg_security_trusted_browser_client_delete
...
CREATE TRIGGER IF NOT EXISTS trg_security_trusted_browser_owner_epoch_change
...
CREATE TRIGGER IF NOT EXISTS trg_security_trusted_browser_installation_change
