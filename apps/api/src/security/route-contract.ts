...
const LEGACY_SCOPE_COMPATIBILITY = new Map<string, readonly string[]>([
  ["GET /api/v1/work", ["work.read"]],
  ["GET /api/v1/work/context", ["work.read"]],
  ["GET /api/v1/work/settings", ["work.read"]],
  ["PATCH /api/v1/work/settings/opportunity-search", ["work.write"]],
  ["GET /api/v1/work/organizations", ["work.read"]],
  ["POST /api/v1/work/organizations", ["work.write"]],
  ["GET /api/v1/work/organizations/:id", ["work.read"]],
  ["PATCH /api/v1/work/organizations/:id", ["work.write"]],
  ["GET /api/v1/work/engagements", ["work.read"]],
  ["POST /api/v1/work/engagements", ["work.write"]],
  ["GET /api/v1/work/engagements/:id", ["work.read"]],
  ["PATCH /api/v1/work/engagements/:id", ["work.write"]],
  ["GET /api/v1/work/metrics/definitions", ["work.read"]],
  ["POST /api/v1/work/metrics/definitions", ["work.write"]],
  ["POST /api/v1/work/check-ins", ["work.write"]],
  ["GET /api/v1/work/metrics/trends", ["work.read"]],
  ["GET /api/v1/work/campaigns", ["work.read"]],
  ["POST /api/v1/work/campaigns", ["work.write"]],
  ["GET /api/v1/work/campaigns/:id", ["work.read"]],
  ["PATCH /api/v1/work/campaigns/:id", ["work.write"]],
  ["POST /api/v1/work/campaigns/:id/criteria", ["work.write"]],
  ["GET /api/v1/work/opportunities", ["work.read"]],
  ["POST /api/v1/work/opportunities/upsert", ["work.write"]],
  ["GET /api/v1/work/opportunities/:id", ["work.read"]],
  ["PATCH /api/v1/work/opportunities/:id", ["work.write"]],
  ["POST /api/v1/work/campaigns/:campaignId/opportunities/:opportunityId/evaluations", ["work.write"]],
  ["GET /api/v1/work/applications", ["work.read"]],
  ["POST /api/v1/work/applications", ["work.write"]],
  ["GET /api/v1/work/applications/:id", ["work.read"]],
  ["PATCH /api/v1/work/applications/:id", ["work.write"]],
  ["POST /api/v1/work/applications/:id/transitions", ["work.write"]],
  ["POST /api/v1/work/applications/:id/events", ["work.write"]],
  ["GET /api/v1/work/supporting/:kind", ["work.read"]],
  ["POST /api/v1/work/supporting/:kind", ["work.write"]],
  ["GET /api/v1/work/supporting/:kind/:id", ["work.read"]],
  ["PATCH /api/v1/work/supporting/:kind/:id", ["work.write"]],
  ["GET /api/v1/work/search-runs", ["work.read"]],
  ["POST /api/v1/work/search-runs", ["work.write"]],
  ["GET /api/v1/work/search-runs/:id", ["work.read"]],
  ["POST /api/v1/work/offers/:id/accept", ["work.transmit"]],
  ["GET /api/v1/work/relationships/:entityType/:id", ["work.read"]],
  ["PUT /api/v1/work/relationships/:entityType/:id", ["work.write"]],
  ["POST /api/v1/work/:entityType/:id/archive", ["work.write"]],
  ["POST /api/v1/work/:entityType/:id/restore", ["work.write"]],
  ["POST /api/v1/work/transmissions/previews", ["work.transmit"]],
  ["POST /api/v1/work/transmissions/previews/:id/request-approval", ["work.transmit"]],
  ["POST /api/v1/work/transmissions/verified-submissions", ["work.transmit"]],
  ...
  ["GET /api/v1/life-force", ["read"]],
  ["PATCH /api/v1/life-force/profile", ["write"]],
  ["PUT /api/v1/life-force/templates/:weekday", ["write"]],
...
const REVIEWED_BODY_LIMIT_OVERRIDES = new Map<string, number>([
  ["POST /api/v1/work/imports/preview", 32 * 1024 * 1024],
  ["POST /api/v1/work/imports/apply", 32 * 1024 * 1024],
