...
enum CompanionScreenshotFixtures {
    ...
    static func movementState() -> MovementSyncStore.PersistedState {
        ...
        let previousLongStay = MovementSyncStore.StoredStay(
            ...
            startedAt: referenceDate.addingTimeInterval(-60 * 60 * 4.68),
            endedAt: referenceDate.addingTimeInterval(-60 * 60 * 2.38),
        ...
        let groceryTripPoints = [
            MovementSyncStore.StoredTripPoint(
                ...
                recordedAt: referenceDate.addingTimeInterval(-60 * 60 * 2.32),
                latitude: 46.52002,
                longitude: 6.63350,
                accuracyMeters: 8,
                altitudeMeters: 376,
            ...
            MovementSyncStore.StoredTripPoint(
                ...
                recordedAt: referenceDate.addingTimeInterval(-60 * 60 * 2.17),
                latitude: 46.52054,
                longitude: 6.63152,
                accuracyMeters: 8,
                altitudeMeters: 374,
            ...
            MovementSyncStore.StoredTripPoint(
                ...
                recordedAt: referenceDate.addingTimeInterval(-60 * 60 * 2.0),
        ...
        let groceryTrip = MovementSyncStore.StoredTrip(
            ...
            startedAt: referenceDate.addingTimeInterval(-60 * 60 * 2.38),
            endedAt: referenceDate.addingTimeInterval(-60 * 60 * 2.0),
        ...
        let groceryStay = MovementSyncStore.StoredStay(
            ...
            status: "completed",
            classification: "known_place",
            startedAt: referenceDate.addingTimeInterval(-60 * 60 * 2.0),
            endedAt: referenceDate.addingTimeInterval(-60 * 60 * 1.58),
        ...
        let homeTripPoints = [
            MovementSyncStore.StoredTripPoint(
                ...
                recordedAt: referenceDate.addingTimeInterval(-60 * 60 * 1.58),
                latitude: groceries.latitude,
                longitude: groceries.longitude,
                accuracyMeters: 7,
                altitudeMeters: 372,
            ...
            MovementSyncStore.StoredTripPoint(
                ...
                recordedAt: referenceDate.addingTimeInterval(-60 * 60 * 1.4),
                latitude: 46.52061,
                longitude: 6.63190,
                accuracyMeters: 8,
                altitudeMeters: 374,
            ...
            MovementSyncStore.StoredTripPoint(
                ...
                recordedAt: referenceDate.addingTimeInterval(-60 * 60 * 1.22),
        ...
        let returnTrip = MovementSyncStore.StoredTrip(
            ...
            travelMode: "walk",
            activityType: "walking",
            startedAt: referenceDate.addingTimeInterval(-60 * 60 * 1.58),
            endedAt: referenceDate.addingTimeInterval(-60 * 60 * 1.22),
        ...
        let ongoingStay = MovementSyncStore.StoredStay(
            ...
            status: "active",
            classification: "known_place",
            startedAt: referenceDate.addingTimeInterval(-60 * 60 * 1.22),
