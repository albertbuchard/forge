...
export const PERFORMANCE_BUDGET_BASIS = Object.freeze({
  ...
  scroll:
    "Binding People goal: desktop p5 FPS >= 55/p95 frame <= 18.2 ms and phone p5 FPS >= 50/p95 frame <= 20 ms on a 60 Hz reference cadence; calibration is bounded to no lower than 50 Hz and raw runner timing remains recorded; zero blank, blue, or content-loss frames.",
  memory:
