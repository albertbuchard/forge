...
usage() {
  cat <<'EOF'
Usage:
  ./scripts/release/release-forge-hermes-plugin.sh <version|patch|minor|major>
  FORGE_RELEASE_MODE=prepare ./scripts/release/release-forge-hermes-plugin.sh <version|patch|minor|major>
  FORGE_RELEASE_MODE=publish-from-tag ./scripts/release/release-forge-hermes-plugin.sh <version>

Examples:
  ./scripts/release/release-forge-hermes-plugin.sh 0.2.19
  ./scripts/release/release-forge-hermes-plugin.sh patch
  FORGE_RELEASE_MODE=prepare ./scripts/release/release-forge-hermes-plugin.sh patch
  FORGE_RELEASE_MODE=publish-from-tag ./scripts/release/release-forge-hermes-plugin.sh 0.2.19
