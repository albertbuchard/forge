...
usage() {
  cat <<EOF
Usage:
  ./scripts/smoke/smoke-test-published-openclaw-plugin.sh [restore]
...
Examples:
  ./scripts/smoke/smoke-test-published-openclaw-plugin.sh
  FORGE_PUBLISHED_PLUGIN_SPEC=forge-openclaw-plugin@latest ./scripts/smoke/smoke-test-published-openclaw-plugin.sh
  ./scripts/smoke/smoke-test-published-openclaw-plugin.sh restore
EOF
}
...
install_published() {
  ...
  echo "  bash ./scripts/smoke/smoke-test-published-openclaw-plugin.sh restore"
}
