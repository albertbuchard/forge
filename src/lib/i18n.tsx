...
function createEnglishDictionary() {
  return {
    ...
    commandPalette: {
      searchPlaceholder: "Jump to a route, goal, project, strategy, or focus task",
...
export const fr: typeof en = {
  common: {
    ...
    commandPalette: {
      searchPlaceholder: "Aller à une vue, un objectif, un projet, une stratégie ou une tâche prioritaire",
