  ...
  return {
    common: {
      ...
      routeDetails: {
        ...
        campaigns: "Review strategic project lanes grouped by the goals they serve.",
    ...
    commandPalette: {
      ...
      routeCampaigns: "Open strategic campaigns.",
...
export const fr: typeof en = {
  common: {
    ...
    routeDetails: {
      ...
      campaigns: "Revoyez les lanes stratégiques de projets regroupées par objectif.",
    ...
    commandPalette: {
      ...
      routeCampaigns: "Ouvrir les campagnes stratégiques.",
