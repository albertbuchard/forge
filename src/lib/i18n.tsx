  ...
  return {
    common: {
      ...
      routeDetails: {
        ...
        wiki: "Search Forge Wiki pages, backlinks, entity links, and the SQLite-backed memory graph.",
    ...
    commandPalette: {
      searchPlaceholder: "Search Forge routes, records, Forge Wiki pages, notes, and active work",
...
export const fr: typeof en = {
  common: {
    ...
    routeDetails: {
      ...
      wiki: "Recherchez pages Forge Wiki, backlinks, liens d'entités et graphe mémoire SQLite.",
