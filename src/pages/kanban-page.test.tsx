...
function createTask({
  ...
  return {
    ...
    aiInstructions: `Complete ${title} in one focused AI session.`,
    executionMode: null,
    acceptanceCriteria: [],
    blockerLinks: [],
      ...
      projects: [
        {
          ...
          targetPoints: 120,
          themeColor: "#c0c1ff",
          productRequirementsDocument: "PRD for Forge Runtime",
          schedulingRules: {
            allowWorkBlockKinds: [],
            blockWorkBlockKinds: [],
            allowCalendarIds: [],
        ...
        },
        {
          ...
          targetPoints: 80,
          themeColor: "#7dd3fc",
          productRequirementsDocument: "PRD for Hermes Concierge",
          schedulingRules: {
            allowWorkBlockKinds: [],
            blockWorkBlockKinds: [],
            allowCalendarIds: [],
          ...
          progress: 0,
          nextTaskId: "task_2",
          nextTaskTitle: "Run concierge sync",
          momentumLabel: "Queued",
          time: {
            totalTrackedSeconds: 0,
            totalCreditedSeconds: 0,
            liveTrackedSeconds: 0,
