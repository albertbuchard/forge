  ...
  return (
    <div className="grid min-w-0 gap-5">
      ...
      <section className="grid gap-3 lg:grid-cols-4">
        ...
        <Card>
          <div className="flex items-center gap-2">
            <div className="font-label text-[11px] uppercase tracking-[0.18em] text-white/45">Task rewards</div>
            <InfoTooltip content="Starting work, staying in work, and completing work all pay XP. Task completion also still awards the task's own XP value." />
          </div>
