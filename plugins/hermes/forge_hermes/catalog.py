...
WORK_ROUTE_SPECS: Dict[str, Dict[str, Any]] = {
    "overview": {"method": "GET", "path": "/api/v1/work"},
    "context": {"method": "GET", "path": "/api/v1/work/context"},
    "settings": {"method": "GET", "path": "/api/v1/work/settings"},
    "updateOpportunitySearch": {"method": "PATCH", "path": "/api/v1/work/settings/opportunity-search", "write": True},
    "listOrganizations": {"method": "GET", "path": "/api/v1/work/organizations"},
    "createOrganization": {"method": "POST", "path": "/api/v1/work/organizations", "write": True},
    "organizationDetail": {"method": "GET", "path": "/api/v1/work/organizations/:id"},
    "updateOrganization": {"method": "PATCH", "path": "/api/v1/work/organizations/:id", "write": True},
    "listEngagements": {"method": "GET", "path": "/api/v1/work/engagements"},
    "createEngagement": {"method": "POST", "path": "/api/v1/work/engagements", "write": True},
    "engagementDetail": {"method": "GET", "path": "/api/v1/work/engagements/:id"},
    "updateEngagement": {"method": "PATCH", "path": "/api/v1/work/engagements/:id", "write": True},
    "metricDefinitions": {"method": "GET", "path": "/api/v1/work/metrics/definitions"},
    "createMetricDefinition": {"method": "POST", "path": "/api/v1/work/metrics/definitions", "write": True},
    "recordCheckIn": {"method": "POST", "path": "/api/v1/work/check-ins", "write": True},
    "metricTrends": {"method": "GET", "path": "/api/v1/work/metrics/trends"},
    "listCampaigns": {"method": "GET", "path": "/api/v1/work/campaigns"},
    "createCampaign": {"method": "POST", "path": "/api/v1/work/campaigns", "write": True},
    "campaignDetail": {"method": "GET", "path": "/api/v1/work/campaigns/:id"},
    "updateCampaign": {"method": "PATCH", "path": "/api/v1/work/campaigns/:id", "write": True},
    "createCriteriaVersion": {"method": "POST", "path": "/api/v1/work/campaigns/:id/criteria", "write": True},
    "listOpportunities": {"method": "GET", "path": "/api/v1/work/opportunities"},
    "upsertOpportunity": {"method": "POST", "path": "/api/v1/work/opportunities/upsert", "write": True},
    "opportunityDetail": {"method": "GET", "path": "/api/v1/work/opportunities/:id"},
    "updateOpportunity": {"method": "PATCH", "path": "/api/v1/work/opportunities/:id", "write": True},
    "evaluateOpportunity": {"method": "POST", "path": "/api/v1/work/campaigns/:campaignId/opportunities/:opportunityId/evaluations", "write": True},
    "listApplications": {"method": "GET", "path": "/api/v1/work/applications"},
    "createApplication": {"method": "POST", "path": "/api/v1/work/applications", "write": True},
    "applicationDetail": {"method": "GET", "path": "/api/v1/work/applications/:id"},
    "updateApplication": {"method": "PATCH", "path": "/api/v1/work/applications/:id", "write": True},
    "transitionApplication": {"method": "POST", "path": "/api/v1/work/applications/:id/transitions", "write": True},
    "recordApplicationEvent": {"method": "POST", "path": "/api/v1/work/applications/:id/events", "write": True},
    "listSupporting": {"method": "GET", "path": "/api/v1/work/supporting/:kind"},
    "createSupporting": {"method": "POST", "path": "/api/v1/work/supporting/:kind", "write": True},
    "supportingDetail": {"method": "GET", "path": "/api/v1/work/supporting/:kind/:id"},
    "updateSupporting": {"method": "PATCH", "path": "/api/v1/work/supporting/:kind/:id", "write": True},
    "listSearchRuns": {"method": "GET", "path": "/api/v1/work/search-runs"},
    "recordSearchRun": {"method": "POST", "path": "/api/v1/work/search-runs", "write": True},
    "searchRunDetail": {"method": "GET", "path": "/api/v1/work/search-runs/:id", "write": False},
    "acceptOffer": {"method": "POST", "path": "/api/v1/work/offers/:id/accept", "write": True},
    "listRelationships": {"method": "GET", "path": "/api/v1/work/relationships/:entityType/:id"},
    "replaceRelationships": {"method": "PUT", "path": "/api/v1/work/relationships/:entityType/:id", "write": True},
    "archive": {"method": "POST", "path": "/api/v1/work/:entityType/:id/archive", "write": True},
    "restore": {"method": "POST", "path": "/api/v1/work/:entityType/:id/restore", "write": True},
    "createTransmissionPreview": {"method": "POST", "path": "/api/v1/work/transmissions/previews", "write": True},
    "requestTransmissionApproval": {"method": "POST", "path": "/api/v1/work/transmissions/previews/:id/request-approval", "write": True},
    "recordVerifiedSubmission": {"method": "POST", "path": "/api/v1/work/transmissions/verified-submissions", "write": True},
}

WORK_ROUTE_EXAMPLES: List[Dict[str, Any]] = [
    {"routeKey": "context", "query": {"userIds": ["user-id"], "trendWindowDays": 90}},
    {"routeKey": "campaignDetail", "pathParams": {"id": "ocamp_example"}, "query": {"userIds": ["user-id"]}},
    {"routeKey": "recordCheckIn", "query": {"userIds": ["user-id"]}, "body": {"engagementId": "weng_example", "observedAt": "2026-08-25T12:00:00+02:00", "timezone": "Europe/Zurich", "sourceKind": "user_entered", "confirmationState": "confirmed", "observations": [{"metricDefinitionId": "wmet_overall_satisfaction", "numericValue": 4, "missingState": "observed"}], "idempotencyKey": "stable-check-in-key"}},
]
...
WORKBENCH_ROUTE_SPECS: Dict[str, Dict[str, Any]] = {
    ...
    "flowVersions": {"method": "GET", "path": "/api/v1/workbench/flows/:id/versions"},
    "flowVersion": {"method": "GET", "path": "/api/v1/workbench/flows/:id/versions/:revision"},
    "restoreFlow": {"method": "POST", "path": "/api/v1/workbench/flows/:id/restore", "write": True},
    ...
    "cancelRun": {"method": "POST", "path": "/api/v1/workbench/flows/:id/runs/:runId/cancel", "write": True},
...
TOOL_CATALOG: List[ToolSpec] = [
    ...
    },
    {
        ...
        "description": "Call one bounded Work route for current or planned Work Engagements, confirmed check-ins and trends, Opportunity Campaigns, sourced opportunities, criteria-versioned evaluations, applications, supporting records, relationships, search-run evidence, offers, or reviewed external-transmission state. This is career and job context, not active task execution and not Workbench. Read current context before changing it. Never relabel an agent suggestion as a user-reported metric, and never claim submission from prepared material. External transmission requires an exact preview, central approval, and direct completion evidence. Every call requires a scoped agent token with work.read, work.write, work.transmit, and work.compensation.read as applicable.",
        "parameters": specialized_route_parameters(WORK_ROUTE_SPECS, WORK_ROUTE_EXAMPLES),
        "method_builder": lambda args: specialized_route_method(WORK_ROUTE_SPECS, args),
        "path_builder": lambda args: specialized_route_path(WORK_ROUTE_SPECS, args),
        "body_builder": specialized_route_body,
        "write_builder": lambda args: specialized_route_write(WORK_ROUTE_SPECS, args),
    ...
    },
    {
        ...
        "description": "Publish an exact questionnaire draft revision as the live readable version. Read the questionnaire first and pass its draft id and update timestamp; stale revisions are rejected.",
        "parameters": object_schema(
            {
                "questionnaireId": {"type": "string", "minLength": 1},
            ...
            required=["questionnaireId", "expectedDraftVersionId", "expectedDraftUpdatedAt"],
        ),
        "method": "POST",
        "path_builder": lambda args: f"/api/v1/psyche/questionnaires/{args['questionnaireId']}/publish",
        "body_builder": lambda args, _config: {
            "label": args.get("label"),
            "expectedDraftVersionId": args.get("expectedDraftVersionId"),
            "expectedDraftUpdatedAt": args.get("expectedDraftUpdatedAt"),
        },
        "write": True,
    },
    {
