...
![Forge overview dashboard](https://raw.githubusercontent.com/albertbuchard/forge/main/plugins/openclaw/docs/assets/forge-overview-dashboard.png)

Psyche graph:

![Forge Psyche graph](https://raw.githubusercontent.com/albertbuchard/forge/main/plugins/openclaw/docs/assets/forge-psyche-graph.png)
...
It exposes `forge_call_work_route` for the separate permanent Work domain: concurrent jobs and contracts, confirmed check-ins and trends, Opportunity Campaigns, sourced roles, evaluations, applications, interviews, offers, documents, search runs, relationships, and reviewed transmission. It never treats those records as task execution or claims submission from prepared material.
