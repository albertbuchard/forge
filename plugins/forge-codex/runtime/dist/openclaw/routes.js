        ...
        operations: [
            {
                ...
                target: (_match, url) => passthroughSearch("/api/v1/movement/day", url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/movement\/month$/,
                upstreamPath: "/api/v1/movement/month",
                target: (_match, url) => passthroughSearch("/api/v1/movement/month", url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/movement\/all-time$/,
                upstreamPath: "/api/v1/movement/all-time",
                target: (_match, url) => passthroughSearch("/api/v1/movement/all-time", url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/movement\/timeline$/,
                upstreamPath: "/api/v1/movement/timeline",
                target: (_match, url) => passthroughSearch("/api/v1/movement/timeline", url)
            },
            {
                method: "GET",
            ...
            },
            {
                ...
                requestBody: "json",
                requiresToken: true,
                target: (match, url) => passthroughSearch(`/api/v1/movement/places/${match[1]}`, url)
            },
            {
                method: "GET",
            ...
            },
            {
                ...
                requestBody: "json",
                target: (_match, url) => passthroughSearch("/api/v1/movement/selection", url)
            },
            {
                method: "GET",
            ...
            },
            {
                ...
                requestBody: "json",
                requiresToken: true,
                target: (_match, url) => passthroughSearch("/api/v1/movement/user-boxes", url)
            },
            {
                method: "POST",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (_match, url) => passthroughSearch("/api/v1/movement/user-boxes/preflight", url)
            },
            {
                method: "PATCH",
                pattern: /^\/forge\/v1\/movement\/user-boxes\/([^/]+)$/,
            ...
            },
            {
                ...
                requestBody: "json",
                requiresToken: true,
                target: (match, url) => passthroughSearch(`/api/v1/movement/automatic-boxes/${match[1]}/invalidate`, url)
            },
            {
                method: "PATCH",
        ...
        operations: [
            {
                ...
                target: (_match, url) => passthroughSearch("/api/v1/life-force", url)
            },
            {
                method: "PATCH",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (_match, url) => passthroughSearch("/api/v1/life-force/profile", url)
            },
            {
                method: "PUT",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (match, url) => passthroughSearch(`/api/v1/life-force/templates/${match[1]}`, url)
            },
            {
                method: "POST",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (_match, url) => passthroughSearch("/api/v1/life-force/fatigue-signals", url)
            }
        ]
    },
    {
        ...
        operations: [
            {
                ...
                target: (_match, url) => passthroughSearch("/api/v1/workbench/catalog/boxes", url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/workbench\/flows$/,
                upstreamPath: "/api/v1/workbench/flows",
                target: (_match, url) => passthroughSearch("/api/v1/workbench/flows", url)
            },
            {
                method: "POST",
                pattern: /^\/forge\/v1\/workbench\/flows$/,
            ...
            },
            {
                ...
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/by-slug/${match[1]}`, url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/workbench\/flows\/([^/]+)$/,
                upstreamPath: "/api/v1/workbench/flows/:id",
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}`, url)
            },
            {
                method: "PATCH",
                pattern: /^\/forge\/v1\/workbench\/flows\/([^/]+)$/,
            ...
            },
            {
                ...
                requestBody: "json",
                requiresToken: true,
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}/run`, url)
            },
            {
                method: "POST",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (_match, url) => passthroughSearch("/api/v1/workbench/run", url)
            },
            {
                method: "POST",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}/chat`, url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/workbench\/flows\/([^/]+)\/output$/,
                upstreamPath: "/api/v1/workbench/flows/:id/output",
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}/output`, url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/workbench\/flows\/([^/]+)\/runs$/,
                upstreamPath: "/api/v1/workbench/flows/:id/runs",
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}/runs`, url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/workbench\/flows\/([^/]+)\/runs\/([^/]+)$/,
                upstreamPath: "/api/v1/workbench/flows/:id/runs/:runId",
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}/runs/${match[2]}`, url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/workbench\/flows\/([^/]+)\/runs\/([^/]+)\/nodes$/,
                upstreamPath: "/api/v1/workbench/flows/:id/runs/:runId/nodes",
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}/runs/${match[2]}/nodes`, url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/workbench\/flows\/([^/]+)\/runs\/([^/]+)\/nodes\/([^/]+)$/,
                upstreamPath: "/api/v1/workbench/flows/:id/runs/:runId/nodes/:nodeId",
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}/runs/${match[2]}/nodes/${match[3]}`, url)
            },
            {
                method: "GET",
                pattern: /^\/forge\/v1\/workbench\/flows\/([^/]+)\/nodes\/([^/]+)\/output$/,
                upstreamPath: "/api/v1/workbench/flows/:id/nodes/:nodeId/output",
                target: (match, url) => passthroughSearch(`/api/v1/workbench/flows/${match[1]}/nodes/${match[2]}/output`, url)
            }
        ]
    },
    {
        ...
        operations: [
            ...
            },
            {
                ...
                requestBody: "json",
                requiresToken: true,
                target: (match, url) => passthroughSearch(`/api/v1/calendar/connections/${match[1]}/sync`, url)
            },
            {
                method: "POST",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (_match, url) => passthroughSearch("/api/v1/calendar/work-block-templates", url)
            },
            {
                method: "POST",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (_match, url) => passthroughSearch("/api/v1/calendar/timeboxes/recommend", url)
            },
            {
                method: "POST",
                ...
                requestBody: "json",
                requiresToken: true,
                target: (_match, url) => passthroughSearch("/api/v1/calendar/timeboxes", url)
            }
        ]
    },
