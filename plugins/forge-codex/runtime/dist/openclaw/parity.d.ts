...
export type ForgeSupportedPluginApiRoute = {
    ...
    path: string;
    purpose: "diagnostics" | "calendar" | "overview" | "operator_context" | "onboarding" | "psyche" | "xp" | "weekly_review" | "entities" | "work" | "insights" | "wiki" | "health" | "movement" | "life_force" | "workbench" | "preferences" | "questionnaires";
};
